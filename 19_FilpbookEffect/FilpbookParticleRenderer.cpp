...
void FilpbookParticleRenderer::Init()
{
...
void FilpbookParticleRenderer::ParticlePass(const Matrix& view, const Matrix& projection, const vector<FilpbookEffect>& effects)
{
